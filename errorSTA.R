...
## Error to minimize according to the method proposed by Han et al. (2015)
...
# Value:
# errorSTA returns a list with class "numeric" 

############################################################################################

errorSTA <- function(prob, prioriProb, means, vars, penalty){
